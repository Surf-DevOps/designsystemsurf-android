...
class DSSScheduleEmptyStateView @JvmOverloads constructor(
    ...
    private val titleLabel = TextView(context).apply {
        ...
        // 16dp de margem em relação à borda esquerda do botão.
        setPadding(16f.dpToPx(context), 0, 0, 0)
    }
    private val benefitsStack = LinearLayout(context).apply {
        orientation = LinearLayout.VERTICAL
        gravity = Gravity.CENTER_HORIZONTAL
        // 24dp de margem em relação à borda esquerda do botão (um pouco mais que o texto).
        setPadding(24f.dpToPx(context), 0, 0, 0)
    }
